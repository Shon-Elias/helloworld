    ...
    async onTurn(turnContext) {
      ...
      // console.log(color.blue("HERE1"))
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            if(text){
              if(text.toLowerCase() === 'hi' || text.toLowerCase() === 'hello' || text.toLowerCase() === 'reboot' ){
            ...
            } else if(text === "DD Service Entry") {
                await dc.beginDialog(HELLO_USER)

            // } else if(text === "EBCP STEPS Contact Entry"){

            //   await dc.beginDialog(HELLO_USER)
            }else if(text === "Ok, I'm ready to start"){
          ...
          }else if(clientProfile.clients.includes(text)){
            ...
            clientProfile.selectedClient = text;
              ...
              await dc.beginDialog("validEndDate")
            }else if(text.includes("You selected:")){
              clientProfile.askedToUpdate = false
            ...
            }if(text === "Not right now, thank you!"){
            ...
            if(startDate){
              if(startDate.includes('-')){
                if(!endDate){
                  ...
                  await dc.beginDialog("DDDisruptionEndDate")
                }
              }
            }
